...
#define LSM6DSOX_FIFO_DATA_OUT_X_L            0x79U
#define LSM6DSOX_FIFO_DATA_OUT_X_H            0x7AU
#define LSM6DSOX_FIFO_DATA_OUT_Y_L            0x7BU
#define LSM6DSOX_FIFO_DATA_OUT_Y_H            0x7CU
#define LSM6DSOX_FIFO_DATA_OUT_Z_L            0x7DU
#define LSM6DSOX_FIFO_DATA_OUT_Z_H            0x7EU

#define LSM6DSOX_SPI2_WHO_AM_I                0x0FU
#define LSM6DSOX_SPI2_STATUS_REG_OIS          0x1EU
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  uint8_t xlda                     : 1;
...
#define LSM6DSOX_SPI2_OUT_TEMP_L              0x20U
#define LSM6DSOX_SPI2_OUT_TEMP_H              0x21U
#define LSM6DSOX_SPI2_OUTX_L_G_OIS            0x22U
#define LSM6DSOX_SPI2_OUTX_H_G_OIS            0x23U
#define LSM6DSOX_SPI2_OUTY_L_G_OIS            0x24U
#define LSM6DSOX_SPI2_OUTY_H_G_OIS            0x25U
#define LSM6DSOX_SPI2_OUTZ_L_G_OIS            0x26U
#define LSM6DSOX_SPI2_OUTZ_H_G_OIS            0x27U
#define LSM6DSOX_SPI2_OUTX_L_A_OIS            0x28U
#define LSM6DSOX_SPI2_OUTX_H_A_OIS            0x29U
#define LSM6DSOX_SPI2_OUTY_L_A_OIS            0x2AU
#define LSM6DSOX_SPI2_OUTY_H_A_OIS            0x2BU
#define LSM6DSOX_SPI2_OUTZ_L_A_OIS            0x2CU
#define LSM6DSOX_SPI2_OUTZ_H_A_OIS            0x2DU
#define LSM6DSOX_SPI2_INT_OIS                 0x6FU
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  uint8_t st_xl_ois                : 2;
...
int32_t lsm6dsox_read_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                          uint8_t *data,
                          uint16_t len);
int32_t lsm6dsox_write_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                           const uint8_t *data,
                           uint16_t len);
...
int32_t lsm6dsox_block_data_update_get(const stmdev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_xl_usr_offset_x_set(const stmdev_ctx_t *ctx, const uint8_t *buff);
int32_t lsm6dsox_xl_usr_offset_x_get(const stmdev_ctx_t *ctx, uint8_t *buff);

int32_t lsm6dsox_xl_usr_offset_y_set(const stmdev_ctx_t *ctx, const uint8_t *buff);
int32_t lsm6dsox_xl_usr_offset_y_get(const stmdev_ctx_t *ctx, uint8_t *buff);

int32_t lsm6dsox_xl_usr_offset_z_set(const stmdev_ctx_t *ctx, const uint8_t *buff);
...
int32_t lsm6dsox_angular_rate_raw_get(const stmdev_ctx_t *ctx,
                                      int16_t *val);

int32_t lsm6dsox_acceleration_raw_get(const stmdev_ctx_t *ctx,
                                      int16_t *val);
...
int32_t lsm6dsox_ln_pg_read(const stmdev_ctx_t *ctx, uint16_t address, uint8_t *buf,
                            uint8_t len);
...
typedef enum
{
  ...
  LSM6DSOX_LIGHT        = 2,
  LSM6DSOX_MEDIUM       = 3,
  LSM6DSOX_STRONG       = 4, /* not available for data rate > 1k670Hz */
  LSM6DSOX_VERY_STRONG  = 5, /* not available for data rate > 1k670Hz */
  LSM6DSOX_AGGRESSIVE   = 6, /* not available for data rate > 1k670Hz */
  LSM6DSOX_XTREME       = 7, /* not available for data rate > 1k670Hz */
} lsm6dsox_ftype_t;
...
typedef enum
{
  LSM6DSOX_PULL_DOWN_DISC       = 0,
  LSM6DSOX_PULL_DOWN_CONNECT    = 1,
} lsm6dsox_int1_pd_en_t;
int32_t lsm6dsox_int1_mode_set(const stmdev_ctx_t *ctx,
                               lsm6dsox_int1_pd_en_t val);
int32_t lsm6dsox_int1_mode_get(const stmdev_ctx_t *ctx,
                               lsm6dsox_int1_pd_en_t *val);
...
int32_t lsm6dsox_pin_mode_get(const stmdev_ctx_t *ctx, lsm6dsox_pp_od_t *val);
...
int32_t lsm6dsox_sh_batch_slave_set(const stmdev_ctx_t *ctx, uint8_t idx, uint8_t val);
int32_t lsm6dsox_sh_batch_slave_get(const stmdev_ctx_t *ctx, uint8_t idx, uint8_t *val);
...
int32_t lsm6dsox_mag_offset_set(const stmdev_ctx_t *ctx, const int16_t *val);
int32_t lsm6dsox_mag_offset_get(const stmdev_ctx_t *ctx, int16_t *val);

int32_t lsm6dsox_mag_soft_iron_set(const stmdev_ctx_t *ctx, const int16_t *val);
int32_t lsm6dsox_mag_soft_iron_get(const stmdev_ctx_t *ctx, int16_t *val);
...
int32_t lsm6dsox_fsm_enable_set(const stmdev_ctx_t *ctx,
                                const lsm6dsox_emb_fsm_enable_t *val);
...
int32_t lsm6dsox_sh_read_data_raw_get(const stmdev_ctx_t *ctx, uint8_t *val,
                                      uint8_t len);
...
int32_t lsm6dsox_sh_cfg_write(const stmdev_ctx_t *ctx,
                              const lsm6dsox_sh_cfg_write_t *val);
...
int32_t lsm6dsox_sh_slv_cfg_read(const stmdev_ctx_t *ctx, uint8_t idx,
                                 lsm6dsox_sh_cfg_read_t *val);

int32_t lsm6dsox_sh_status_get(const stmdev_ctx_t *ctx,
                               const lsm6dsox_status_master_t *val);
...
int32_t lsm6dsox_id_get(const stmdev_ctx_t *ctx, const stmdev_ctx_t *aux_ctx,
                        lsm6dsox_id_t *val);
...
typedef enum
{
  ...
  LSM6DSOX_I3C_T_50us  = 0x02, /* I3C: available time equal to 50 us */
  LSM6DSOX_I3C_T_2us   = 0x12, /* I3C: available time equal to 2 us */
  LSM6DSOX_I3C_T_1ms   = 0x22, /* I3C: available time equal to 1 ms */
  LSM6DSOX_I3C_T_25ms  = 0x32, /* I3C: available time equal to 25 ms */
} lsm6dsox_ui_bus_md_t;

typedef enum
{
  LSM6DSOX_SPI_4W_AUX  = 0x00,
  LSM6DSOX_SPI_3W_AUX  = 0x01,
} lsm6dsox_aux_bus_md_t;

typedef struct
{
  lsm6dsox_ui_bus_md_t ui_bus_md;
  lsm6dsox_aux_bus_md_t aux_bus_md;
} lsm6dsox_bus_mode_t;
...
int32_t lsm6dsox_status_get(const stmdev_ctx_t *ctx, const stmdev_ctx_t *aux_ctx,
...
typedef struct
{
  struct
  {
    struct
    {
      lsm6dsox_ui_odr_xl_t odr;
      lsm6dsox_ui_fs_xl_t fs;
    } xl;
    struct
    {
      lsm6dsox_ui_odr_g_t odr;
      lsm6dsox_ui_fs_g_t fs;
    } gy;
  } ui;
  struct
  {
    lsm6dsox_ois_ctrl_md_t ctrl_md;
    struct
    {
      lsm6dsox_ois_xl_odr_t odr;
      lsm6dsox_ois_xl_fs_t fs;
    } xl;
    struct
    {
      lsm6dsox_ois_gy_odr_t odr;
      lsm6dsox_ois_gy_fs_t fs;
    } gy;
  } ois;
  struct
  {
    lsm6dsox_sens_fsm_t sens;
    lsm6dsox_odr_fsm_t odr;
  } fsm;
  struct
  {
    lsm6dsox_mlc_sens_t sens;
    lsm6dsox_mlc_odr_t odr;
  } mlc;
} lsm6dsox_md_t;

int32_t lsm6dsox_mode_set(const stmdev_ctx_t *ctx,
                          const stmdev_ctx_t *aux_ctx,
                          lsm6dsox_md_t *val);
int32_t lsm6dsox_mode_get(const stmdev_ctx_t *ctx,
                          const stmdev_ctx_t *aux_ctx,
                          lsm6dsox_md_t *val);
...
int32_t lsm6dsox_data_get(const stmdev_ctx_t *ctx, const stmdev_ctx_t *aux_ctx,
                          const lsm6dsox_md_t *md, lsm6dsox_data_t *data);
typedef struct
{
